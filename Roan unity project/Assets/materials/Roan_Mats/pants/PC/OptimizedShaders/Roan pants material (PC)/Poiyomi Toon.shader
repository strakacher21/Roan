Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/980de9b2347ae1e40ab25548b3fafaf1"
{
	Properties
	{
		...
		_PPHue_Roanpantsmaterial28PC29 ("Hue", Range(0, 1)) = 0
		[HDR]_PPTint ("Tint", Color) = (1, 1, 1, 1)
		[VectorLabel(R,G,B)]_PPRGB ("RGB", Vector) = (1, 1, 1, 1)
		_PPContrast ("Contrast", Float) = 1
		_PPSaturation_Roanpantsmaterial28PC29 ("Saturation", Float) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 _PPTint;
			float3 _PPRGB;
			float _PPHue_Roanpantsmaterial28PC29;
			float _PPContrast;
			float _PPSaturation_Roanpantsmaterial28PC29;
			float _PPBrightness;
			float _PPLightness;
			float _PPHDR;
			...
			void applyPostProcessing(inout PoiFragData poiFragData, in PoiMesh poiMesh)
			{
				...
				col = hueShift(col, _PPHue_Roanpantsmaterial28PC29, 1.0, 1.0);
				col *= float4(1,1,1,1);
				col *= float4(1,1,1,1);
				col = GetSaturation(col, _PPSaturation_Roanpantsmaterial28PC29);
