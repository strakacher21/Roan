Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/a9f29c1824893a34a81ae6371467a7a9"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 _PPTint;
			float3 _PPRGB;
			float _PPHue_Roanhandsmaterial;
			float _PPContrast;
			float _PPSaturation_Roanhandsmaterial;
			float _PPBrightness;
			float _PPLightness;
			float _PPHDR;
			...
			void applyPostProcessing(inout PoiFragData poiFragData, in PoiMesh poiMesh)
			{
				...
				col = hueShift(col, _PPHue_Roanhandsmaterial, 1.0, 1.0);
				col *= float4(1,1,1,1);
				col *= float4(1,1,1,1);
				col = GetSaturation(col, _PPSaturation_Roanhandsmaterial);
