Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/a9f29c1824893a34a81ae6371467a7a9"
{
	Properties
	{
		...
		_PPHue_Roanhandsmaterial28PC29 ("Hue", Range(0, 1)) = 0
		[HDR]_PPTint ("Tint", Color) = (1, 1, 1, 1)
		[VectorLabel(R,G,B)]_PPRGB ("RGB", Vector) = (1, 1, 1, 1)
		_PPContrast ("Contrast", Float) = 1
		_PPSaturation_Roanhandsmaterial28PC29 ("Saturation", Float) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 _PPTint;
			float3 _PPRGB;
			float _PPHue_Roanhandsmaterial28PC29;
			float _PPContrast;
			float _PPSaturation_Roanhandsmaterial28PC29;
			float _PPBrightness;
			float _PPLightness;
			float _PPHDR;
			...
			void applyPostProcessing(inout PoiFragData poiFragData, in PoiMesh poiMesh)
			{
				...
				col = hueShift(col, _PPHue_Roanhandsmaterial28PC29, 1.0, 1.0);
				col *= float4(1,1,1,1);
				col *= float4(1,1,1,1);
				col = GetSaturation(col, _PPSaturation_Roanhandsmaterial28PC29);
